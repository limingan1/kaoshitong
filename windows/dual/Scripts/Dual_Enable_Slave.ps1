...
$global:Step5_Path = "{0}\Scripts\Dual_5_Slave_NewSubscription.sql" -f $global:SMC20_Install_Path
...
function Do_SQL_UpdateInit($dbName, $SqlStr,[string[]]$params)
{
	...
	return .\SQLCMD.EXE -S $global:Slave_Server_Name -d $dbName -i $SqlStr -v $params -N -C -l 100
}

Write_Log -msg "Begin Enable Slave..."
#Dual_5_Slave_NewSubscription
$Step5Param1 = "Master_Server_Name={0}" -f $global:Master_Server_Name
$Step5Param2 = "Slave_Server_Name={0}" -f $global:Slave_Server_Name
$Step5Param3 = "SMC_Service_User={0}" -f $global:SMC_Service_User
$Step5Param4 = "Service_User_Pwd={0}" -f $global:Service_User_Pwd
$Step5Params = $Step5Param1,$Step5Param2,$Step5Param3,$Step5Param4
Do_SQL_Update "master" $global:Step5_Path -params $Step5Params | Out-File -Encoding ASCII -FilePath $Target_Log -Append