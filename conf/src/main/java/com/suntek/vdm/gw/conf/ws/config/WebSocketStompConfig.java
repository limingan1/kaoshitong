...
import com.suntek.vdm.gw.conf.ws.handler.MyPrincipalHandshakeHandler;
import com.suntek.vdm.gw.conf.ws.handler.WebSocketChannelInterceptor;
import com.suntek.vdm.gw.conf.ws.handler.WebSocketInterceptor;
...
public class WebSocketStompConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
         ...
         */
        registry.addEndpoint("/websocket/websocket")
                .setAllowedOrigins("*")
    ...
    public void configureMessageBroker(MessageBrokerRegistry registry) {
        ...
        /*
         *  "/topic" 为配置应用服务器的地址前缀，表示所有以/topic 开头的客户端消息或请求
         *  都会路由到带有@SubscribeMapping 注解的方法中
         */
         ...
         */
         /*   补充说明 一对一推送时,订阅的前缀  推
            例如 客户端订阅 /user/topic/conferences 则服务端推送路径为 /topic/conferences */
