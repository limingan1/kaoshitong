...
$global:Step7_Path = "{0}\Scripts\Dual_7_DisablePublishingDistribution.sql" -f $global:SMC20_Install_Path
...
$Step7Param1 = "Slave_Server_Name={0}" -f $global:Slave_Server_Name
$Step7Param2 = "Master_Server_Name={0}" -f $global:Master_Server_Name
$Step7Params = $Step7Param1,$Step7Param2
Do_SQL_Update "master" $global:Step7_Path -params $Step7Params | Out-File -Encoding ASCII -FilePath $Target_Log -Append