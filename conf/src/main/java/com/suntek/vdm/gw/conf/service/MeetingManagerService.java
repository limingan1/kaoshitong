...
import com.suntek.vdm.gw.smc.pojo.ConferenceRsp;
...
public interface MeetingManagerService {
    /**
     * 预约会议
     * @param scheduleMeetingRequestEx
     * @param token
     * @return
     * @throws MyHttpException
     */
    ScheduleMeetingResponse scheduleConferences(ScheduleMeetingRequestEx scheduleMeetingRequestEx, String token) throws MyHttpException;


    void transferScheduleMeetingData(ConferenceRsp resConference, ConferenceRsp conference);

    ScheduleMeetingResponseEx scheduleConferences(ScheduleMeetingRequestEx request, ScheduleMeetingResponse response, String token) throws MyHttpException;

    /**
     * 获取会议列表
     * @param getConditionsMeetingRequest
     * @param token
     * @param page
     * @param size
     * @return
     * @throws MyHttpException
     */
    GetConditionsMeetingResponse getConditions(GetConditionsMeetingRequest getConditionsMeetingRequest, String token, Integer page, Integer size) throws MyHttpException;
    ...
    List<GetSiteRegiesterStatusResp> getStieRegister(GetSiteRegiesterStatusReq getSiteRegiesterStatusReq, String token) throws MyHttpException;
}
