...
public class ReflectUtil {
     ...
     * @param target：复制到这个对象来
     */
    public static void copyPropertiesSimpleAndSuper(Object source,Object target){

        Map<String,Field> targetFieldMap=new HashMap<>(getClassFieldMapWithCache(target.getClass()));
        targetFieldMap.putAll(new HashMap<>(getClassFieldMapWithCache(target.getClass().getSuperclass())));
        copyObjectProperties(
                source,new HashMap<>(getClassFieldMapWithCache(source.getClass())),
                target,targetFieldMap);
    }
        ...
        if(softReference == null || softReference.get() == null){
            ...
            synchronized(sourceClass){
                ...
                if(softReference == null || softReference.get() == null){
                    ...
                    Class object. This includes basic, protected, default access, and private fields, but excludes inherited fields
                    */
